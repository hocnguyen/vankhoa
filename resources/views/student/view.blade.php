        ...
        <div class="row view-std">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <?php echo $model->birthday; echo Form::label('', date("d-m-Y",strtotime($model->birthday)), ['class' => 'form-control']); ?>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <?php echo Form::label('', $model->school_name, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Lớp ở trường Úc 2017 (Year Level in day school)</label>
                    <?php echo Form::label('', $model->year_level_in_day_school, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="fix-col-lg-6">
                    <div class="form-group">
                        <label >Campus</label>
                        <?php echo Form::label('', $model->campus, ['class' => 'form-control']); ?>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <?php echo Form::textarea('', $model->school_address, ['class' => 'form-control', "readonly"]); ?>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <?php echo Form::radio('', 1, ($model->is_over_seas_student == 1) ? true : "", ['class' => 'fix-space-lbl', 'readonly']); ?>
                <label for="no_over">No</label>
                <?php echo Form::radio('', 2, ($model->is_over_seas_student == 2) ? true : "", ['class' => 'fix-space-lbl', 'readonly']); ?>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <?php echo Form::radio('', 1, ($model->is_temporary_visa == 1) ? true : "", ['class' => 'fix-space-lbl', 'readonly']); ?>
                <label for="no_visa">No</label>
                <?php echo Form::radio('', 2, ($model->is_temporary_visa == 2) ? true : "", ['class' => 'fix-space-lbl', 'readonly']); ?>
            ...
            <div class="col-lg-12">
                ...
                <?php echo Form::radio('', 1, ($model->is_vsl == 1) ? true : "", ['class' => 'fix-space-lbl', 'readonly']); ?>
                <label for="no_vsl">No</label>
                <?php echo Form::radio('', 2, ($model->is_vsl == 2) ? true : "", ['class' => 'fix-space-lbl', 'readonly']); ?>

            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Nếu có, viết địa điểm VSL (If YES, VSL Centre location)</label>
                    <?php echo Form::label('', $model->address_vsl, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Học ngôn ngữ nào? (Language studied)</label>
                    <?php echo Form::label('', $model->languages_vsl, ['class' => 'form-control']); ?>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <?php echo Form::label('', $model->mom_name, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Họ tên của ba (Dad’s full name)</label>
                    <?php echo Form::label('', $model->dad_name, ['class' => 'form-control']); ?>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <?php echo Form::label('', $model->mom_phone, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Mobile number (Ba – dad’s)</label>
                    <?php echo Form::label('', $model->dad_phone, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Email address (mẹ ‐ mum’s)</label>
                    <?php echo Form::label('', $model->mom_email, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Email address (ba ‐ dad’s)</label>
                    <?php echo Form::label('', $model->dad_email, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Tên người giám hộ (Name of Legal Guardian)</label>
                    <?php echo Form::label('', $model->guardian_name, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Date Of Enrollment</label>
                    <?php echo Form::label('', date("d-m-Y",strtotime($model->date)), ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label >Quan hệ (Relationship to student)</label>
                    <?php echo Form::label('', $model->relation, ['class' => 'form-control']); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
